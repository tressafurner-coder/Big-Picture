  ...
  return (
    <div className="min-h-dvh w-full bg-[#F7F8F9] px-4 py-8">
      <div className="mx-auto max-w-3xl">
        <Link
          to="/"
          className="text-sm font-normal text-[#0C66E4] underline-offset-4 hover:underline"
        >
          ← All prototypes
        </Link>

        <header className="mt-6 border-b border-[#DFE1E6] pb-6">
          <h1 className="text-2xl font-normal tracking-tight text-[#172B4D]">
        ...
        <section className="mt-8 rounded-lg border border-[#DFE1E6] bg-white p-6 shadow-sm">
          <p className="mb-6 text-xs font-normal uppercase tracking-wide text-[#44546F]">
            Dropdowns behavior
          </p>
          <div className="space-y-10">
            <div>
              <p className="mb-4 text-xs font-normal uppercase tracking-wide text-[#44546F]">
                With teams
              </p>
              <BigPictureTeamsDropdown />
            </div>
                ...
                <table className="w-full table-fixed border-collapse text-left text-sm text-[#172B4D]">
                  ...
                  <thead>
                    <tr className="border-b border-[#DFE1E6] bg-[#FAFBFC]">
                      <th className="px-3 py-2.5 text-xs font-normal uppercase tracking-wide text-[#626F86]">
                        OKR
                      </th>
                      <th className="px-3 py-2.5 text-xs font-normal uppercase tracking-wide text-[#626F86]">
                        Teams
        ...
        <section className="mt-8 rounded-lg border border-[#DFE1E6] bg-white p-6 shadow-sm">
          ...
          <div className="space-y-10">
            <div>
              <p className="mb-3 text-xs font-normal text-[#626F86]">
